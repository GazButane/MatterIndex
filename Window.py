...
"border-radius: 15px;")
        ...
        self.tablist.setIconSize(QtCore.QSize(16, 16))
        self.tablist.setElideMode(QtCore.Qt.TextElideMode.ElideNone)
        self.tablist.setDocumentMode(False)
        self.tablist.setTabsClosable(False)
        self.tablist.setTabBarAutoHide(True)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 982, 545))
